    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-800">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-green-400 text-sm">Season {currentSeason} • Week {gameWeek}</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
      ...
      <div className="container mx-auto px-4 py-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid grid-cols-6 w-full bg-slate-800/50 border border-green-500/20">
              ...
              <Card className="bg-slate-800/50 border-green-500/20">
                <CardHeader>
                  ...
                  <CardDescription className="text-green-400">
                    Premier League • Position {clubStats.position}
                  </CardDescription>
                </CardHeader>
